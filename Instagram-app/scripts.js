...
// Ubah nama makanan "Pecel" menjadi "Tahu Telor"
const indexPecel = daftarMakanan.findIndex(item => item.nama === 'Pecel');
if (indexPecel !== -1) {
    daftarMakanan[indexPecel].nama = 'Tahu Telor';
}

// Tambahkan item "Nasi Goreng" dengan harga 12000 ke dalam array
...
const postsContainer2 = document.getElementById('postsContainer2'); // Perbaikan disini, ubah ID sesuai dengan ID yang ada di HTML
